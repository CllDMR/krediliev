  ...
  return (
    <>
      <div className=" bg-[#f7f7f7]  py-12">
        ...
        <p className="text-[12px] text-center">Lorem ipsum dolor sit amet</p>
        <div className="container mx-auto ">
          <Slider className="w-full " {...settings}>
            <div className="bg-white shadow-xl rounded-lg  max-w-sm  flex items-center justify-center font-sans ">
              <Image src="/images/ev.jpg" width="318px" height="224px" />
              ...
              <div className="p-4">
                ...
                <p className="text-gray-700">
                  Çeşme Aysaranda Mevki Özel Plajlı Denize Yakın Müstakil Yazlık
                </p>
              </div>
              <div className="flex p-4 border-t border-gray-100 text-gray-700">
                <div className="flex-1 inline-flex items-center">
                  ...
                  <p className="text-xl ml-2 text-gray-900">750,000₺</p>
                </div>
                <div className="flex-1 inline-flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
